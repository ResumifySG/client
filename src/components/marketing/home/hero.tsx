...
export function Hero(): React.JSX.Element {
  ...
  const [img, setImg] = React.useState<string>('/static/assets/home-hero-light.png');

  React.useEffect(() => {
    setImg(colorScheme === 'dark' ? '/static/assets/home-hero-dark.png' : '/static/assets/home-hero-light.png');
  }, [colorScheme]);
  ...
  return (
    ...
    >
      ...
      >
        <Box component="img" src="/static/assets/home-cosmic.svg" sx={{ height: 'auto', width: '1600px' }} />
      </Box>
      <Box
        sx={{
          alignItems: 'center',
      ...
      >
        <Box component="img" src="/static/assets/home-rectangles.svg" sx={{ height: 'auto', width: '1900px' }} />
      </Box>
        ...
        <Stack spacing={4}>
          ...
          <Stack direction="row" spacing={1} sx={{ alignItems: 'center', justifyContent: 'center ' }}>
            <AvatarGroup sx={{ '& .MuiAvatar-root': { border: '2px solid var(--mui-palette-neutral-950)' } }}>
              <Avatar alt="User 5" src="/static/assets/avatar-5.png" />
              <Avatar alt="User 1" src="/static/assets/avatar-1.png" />
              <Avatar alt="User 2" src="/static/assets/avatar-2.png" />
            </AvatarGroup>
