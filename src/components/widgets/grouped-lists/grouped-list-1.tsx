...
const events = [
  {
    ...
    customer: { name: 'Marcus Finn', avatar: '/static/assets/avatar-9.png' },
  ...
  },
  {
    ...
    type: 'payment',
    description: 'Purchased subscription',
    customer: { avatar: '/static/assets/avatar-8.png', name: 'Jie Yan' },
  ...
  },
  {
    ...
    type: 'payment',
    description: 'Purchased subscription',
    customer: { name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
    createdAt: dayjs().subtract(5, 'minute').toDate(),
  },
] satisfies Event[];
