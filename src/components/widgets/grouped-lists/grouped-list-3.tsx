...
const tasks = [
  {
    ...
    members: [
      { name: 'Marcus Finn', avatar: '/static/assets/avatar-9.png' },
      { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png' },
    ],
  },
  {
    id: 'TSK-005',
    ...
    members: [
      { name: 'Penjani Inyene', avatar: '/static/assets/avatar-4.png' },
  ...
  },
  {
    ...
    members: [{ name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png' }],
  },
  {
    id: 'TSK-003',
    ...
    members: [
      { name: 'Marcus Finn', avatar: '/static/assets/avatar-9.png' },
      { name: 'Siegbert Gottfried', avatar: '/static/assets/avatar-2.png' },
    ],
  },
  {
    id: 'TSK-002',
    ...
    members: [
      { name: 'Jie Yan', avatar: '/static/assets/avatar-8.png' },
      { name: 'Marcus Finn', avatar: '/static/assets/avatar-9.png' },
      { name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
    ],
  },
  {
    ...
    members: [{ name: 'Penjani Inyene', avatar: '/static/assets/avatar-4.png' }],
  },
] satisfies Task[];
