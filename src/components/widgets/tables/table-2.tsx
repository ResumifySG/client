...
const projects = [
  {
    ...
    author: { name: 'Jie Yan', avatar: '/static/assets/avatar-8.png' },
    currency: 'USD',
    budget: 12500,
  ...
  },
  {
    ...
    author: { name: 'Omar Darobe', avatar: '/static/assets/avatar-11.png' },
    currency: 'USD',
    budget: 15750,
  ...
  },
  {
    ...
    author: { name: 'Siegbert Gottfried', avatar: '/static/assets/avatar-2.png' },
    currency: 'USD',
    budget: 15750,
  ...
  },
  {
    ...
    technologies: ['vue-js'],
    author: { name: 'Iulia Albu', avatar: '/static/assets/avatar-6.png' },
    currency: 'USD',
    budget: 12500,
  ...
  },
  {
    ...
    author: { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png' },
    currency: 'USD',
    budget: 15750,
...
const technologyIcons: Record<string, string> = {
  'html-css': '/static/assets/logo-html.svg',
  'react-js': '/static/assets/logo-react-js.svg',
  'vue-js': '/static/assets/logo-vue-js.svg',
  angular: '/static/assets/logo-angular.svg',
  figma: '/static/assets/logo-figma.svg',
  sketch: '/static/assets/logo-sketch.svg',
};
