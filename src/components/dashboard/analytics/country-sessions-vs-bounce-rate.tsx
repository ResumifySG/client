...
const countries = {
  ca: { name: 'Canada', flag: '/static/assets/flag-ca.svg' },
  de: { name: 'Germany', flag: '/static/assets/flag-de.svg' },
  ru: { name: 'Russia', flag: '/static/assets/flag-ru.svg' },
  uk: { name: 'United Kingdom', flag: '/static/assets/flag-uk.svg' },
  us: { name: 'United States', flag: '/static/assets/flag-us.svg' },
} as const;
