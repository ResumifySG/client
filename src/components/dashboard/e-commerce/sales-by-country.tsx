...
const geoUrl = '/static/assets/world-countries.json';

export type CountryCode = 'au' | 'ca' | 'de' | 'es' | 'in' | 'ru' | 'uk' | 'us';

const flagIcons: Record<CountryCode, string> = {
  au: '/static/assets/flag-au.svg',
  ca: '/static/assets/flag-ca.svg',
  de: '/static/assets/flag-de.svg',
  es: '/static/assets/flag-es.svg',
  in: '/static/assets/flag-in.svg',
  ru: '/static/assets/flag-ru.svg',
  uk: '/static/assets/flag-uk.svg',
  us: '/static/assets/flag-us.svg',
};
