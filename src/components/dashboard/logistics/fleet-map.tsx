    ...
    return (
      ...
      >
        <Stack spacing={2} sx={{ alignItems: 'center' }}>
          <Box component="img" src="/static/assets/error.svg" sx={{ height: 'auto', maxWidth: '100%', width: '120px' }} />
          <Stack spacing={1}>
    ...
    >
      {vehicles.map((vehicle) => (
        ...
        >
          ...
          >
            <Box alt="Marker" component="img" src="/static/assets/marker-truck.png" sx={{ height: '100%' }} />
          </Box>
        </Marker>
      ))}
    </Mapbox>
