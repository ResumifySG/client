...
export const languageFlags = {
  en: '/static/assets/flag-uk.svg',
  de: '/static/assets/flag-de.svg',
  es: '/static/assets/flag-es.svg',
} as const;

const languageOptions = {
  en: { icon: '/static/assets/flag-uk.svg', label: 'English' },
  de: { icon: '/static/assets/flag-de.svg', label: 'German' },
  es: { icon: '/static/assets/flag-es.svg', label: 'Spanish' },
} as const;
