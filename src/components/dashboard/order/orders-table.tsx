...
const columns = [
  ...
  },
  {
    formatter: (row): React.JSX.Element | null => {
      ...
      const mapping = {
        mastercard: { name: 'Mastercard', logo: '/static/assets/payment-method-1.png' },
        visa: { name: 'Visa', logo: '/static/assets/payment-method-2.png' },
        amex: { name: 'American Express', logo: '/static/assets/payment-method-3.png' },
        applepay: { name: 'Apple Pay', logo: '/static/assets/payment-method-4.png' },
        googlepay: { name: 'Google Pay', logo: '/static/assets/payment-method-5.png' },
      } as const;
