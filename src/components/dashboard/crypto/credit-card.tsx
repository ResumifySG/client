...
const brandBgs: Record<Brand, string> = {
  mastercard: '/static/assets/card-background-1.png',
  visa: '/static/assets/card-background-2.png',
};

const brandIcons: Record<Brand, string> = { mastercard: '/static/assets/logo-mastercard.svg', visa: '/static/assets/logo-visa.svg' };
  ...
  return (
    ...
    >
      <Box sx={{ alignItems: 'center', display: 'flex', justifyContent: 'space-between' }}>
        <Box alt="Contactless" component="img" src="/static/assets/contactless.svg" sx={{ height: 'auto', width: '24px' }} />
