...
//   { id: 'google', name: 'Google', logo: '/static/assets/logo-google.svg' },
//   { id: 'discord', name: 'Discord', logo: '/static/assets/logo-discord.svg' },
...
export function SignUpForm(): React.JSX.Element {
  ...
  const onSubmit = React.useCallback(
    async (values: Values): Promise<void> => {
      ...
      const redirectToUrl = new URL(paths.auth.supabase.callback.pkce, window.location.origin);
      redirectToUrl.searchParams.set('next', paths.dashboard.resume);
