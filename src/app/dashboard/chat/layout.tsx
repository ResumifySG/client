...
const contacts = [
  {
    ...
    avatar: '/static/assets/avatar-10.png',
    isActive: false,
  ...
  { id: 'USR-005', name: 'Fran Perez', avatar: '/static/assets/avatar-5.png', isActive: true, lastActivity: dayjs().toDate() },
  { id: 'USR-006', name: 'Iulia Albu', avatar: '/static/assets/avatar-6.png', isActive: true, lastActivity: dayjs().toDate() },
  { id: 'USR-008', name: 'Jie Yan', avatar: '/static/assets/avatar-8.png', isActive: true, lastActivity: dayjs().toDate() },
  {
    id: 'USR-009',
    name: 'Marcus Finn',
    avatar: '/static/assets/avatar-9.png',
    isActive: false,
  ...
  },
  {
    id: 'USR-007',
    name: 'Nasimiyu Danai',
    avatar: '/static/assets/avatar-7.png',
    isActive: true,
    lastActivity: dayjs().toDate(),
  },
  {
    id: 'USR-011',
    name: 'Omar Darobe',
    avatar: '/static/assets/avatar-11.png',
    isActive: true,
    lastActivity: dayjs().toDate(),
  },
  {
...
const threads = [
  {
    ...
    type: 'direct',
    participants: [
      { id: 'USR-000', name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
      { id: 'USR-003', name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png' },
    ],
    unreadCount: 0,
  },
  {
    ...
    participants: [
      { id: 'USR-000', name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
      { id: 'USR-005', name: 'Fran Perez', avatar: '/static/assets/avatar-5.png' },
    ],
    unreadCount: 1,
  },
  {
    ...
    participants: [
      { id: 'USR-000', name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
      { id: 'USR-007', name: 'Nasimiyu Danai', avatar: '/static/assets/avatar-7.png' },
      { id: 'USR-001', name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png' },
    ],
    unreadCount: 0,
  },
  {
    ...
    participants: [
      { id: 'USR-000', name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
      { id: 'USR-010', name: 'Alcides Antonio', avatar: '/static/assets/avatar-10.png' },
    ],
    unreadCount: 2,
  },
] satisfies Thread[];
...
const messages = [
  {
    ...
    author: { id: 'USR-000', name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
  ...
  },
  {
    ...
    author: { id: 'USR-005', name: 'Fran Perez', avatar: '/static/assets/avatar-5.png' },
  ...
  },
  {
    ...
    author: { id: 'USR-001', name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png' },
  ...
  },
  {
    ...
    author: { id: 'USR-007', name: 'Nasimiyu Danai', avatar: '/static/assets/avatar-7.png' },
  ...
  },
  {
    ...
    threadId: 'TRD-001',
    type: 'image',
    content: '/static/assets/image-abstract-1.png',
    author: { id: 'USR-010', name: 'Alcides Antonio', avatar: '/static/assets/avatar-10.png' },
