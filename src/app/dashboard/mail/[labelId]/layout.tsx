...
const threads = [
  {
    id: 'TRD-004',
    from: { avatar: '/static/assets/avatar-9.png', email: 'marcus.finn@domain.com', name: 'Marcus Finn' },
    to: [{ avatar: '/static/assets/avatar.png', email: 'sofia@devias.io', name: 'Sofia Rivers' }],
...
Marcus Finn`,
    attachments: [
      ...
      { id: 'ATT-002', name: 'summer-customers.pdf', size: '782.3 KB', type: 'file', url: '#' },
      {
        ...
        size: '568.2 KB',
        type: 'image',
        url: '/static/assets/image-minimal-1.png',
      },
    ],
    folder: 'inbox',
  ...
  {
    id: 'TRD-003',
    to: [{ name: 'Sofia Rivers', avatar: '/static/assets/avatar.png', email: 'sofia@devias.io' }],
    from: { name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png', email: 'miron.vitold@domain.com' },
  ...
  {
    id: 'TRD-002',
    from: { name: 'Penjani Inyene', avatar: '/static/assets/avatar-4.png', email: 'penjani.inyene@domain.com' },
    to: [{ name: 'Sofia Rivers', avatar: '/static/assets/avatar.png', email: 'sofia@devias.io' }],
...
Your flight is coming up soon. Please don't forget to check in for your scheduled flight.`,
  ...
  {
    id: 'TRD-001',
    from: { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png', email: 'carson.darrin@domain.com' },
    to: [{ name: 'Sofia Rivers', avatar: '/static/assets/avatar.png', email: 'sofia@devias.io' }],
