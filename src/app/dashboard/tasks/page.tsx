...
const tasks = [
  {
    id: 'TSK-001',
    author: { id: 'USR-000', name: 'Sofia Rivers', username: 'sofia.rivers', avatar: '/static/assets/avatar.png' },
    ...
    assignees: [{ id: 'USR-007', name: 'Nasimiyu Danai', username: 'nasimiyu.danai', avatar: '/static/assets/avatar-7.png' }],
    attachments: [
      {
        id: 'ATT-001',
        name: 'image-abstract-1.png',
        extension: 'png',
        url: '/static/assets/image-abstract-1.png',
        size: '24.8 KB',
      },
    ],
    subtasks: [
    ...
    comments: [
      {
        id: 'MSG-001',
        author: { id: 'USR-007', name: 'Nasimiyu Danai', username: 'nasimiyu.danai', avatar: '/static/assets/avatar-7.png' },
  ...
  {
    id: 'TSK-002',
    author: { id: 'USR-005', name: 'Fran Perez', username: 'fran.perez', avatar: '/static/assets/avatar-5.png' },
    ...
    subscribed: true,
    assignees: [
      { id: 'USR-005', name: 'Fran Perez', username: 'fran.perez', avatar: '/static/assets/avatar-5.png' },
      { id: 'USR-007', name: 'Nasimiyu Danai', username: 'nasimiyu.danai', avatar: '/static/assets/avatar-7.png' },
    ],
    attachments: [],
    subtasks: [],
    comments: [],
  ...
  {
    id: 'TSK-003',
    author: { id: 'USR-009', name: 'Marcus Finn', username: 'marcus.finn', avatar: '/static/assets/avatar-9.png' },
    title: 'Setup onboarding tour for new users',
    columnId: 'COL-003',
    createdAt: dayjs().subtract(3, 'day').toDate(),
    assignees: [
      { id: 'USR-003', name: 'Carson Darrin', username: 'carson.darrin', avatar: '/static/assets/avatar-3.png' },
      { id: 'USR-000', name: 'Sofia Rivers', username: 'sofia.rivers', avatar: '/static/assets/avatar.png' },
    ],
    attachments: [],
    subtasks: [
  ...
  {
    id: 'TSK-004',
    author: { id: 'USR-003', name: 'Carson Darrin', username: 'carson.darrin', avatar: '/static/assets/avatar-3.png' },
    title: 'Follow up with Devias team',
    description: 'We need to finish the project as soon as possible',
    columnId: 'COL-003',
    createdAt: dayjs().subtract(3, 'day').toDate(),
    subscribed: true,
    assignees: [{ id: 'USR-009', name: 'Marcus Finn', username: 'marcus.finn', avatar: '/static/assets/avatar-9.png' }],
    attachments: [],
    subtasks: [],
    comments: [
      {
