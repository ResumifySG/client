...
const comments = [
  {
    ...
    author: { name: 'Alcides Antonio', avatar: '/static/assets/avatar-10.png' },
      ...
      <Stack spacing={8}>
        ...
        <Stack spacing={3}>
          ...
          <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
            <Avatar src="/static/assets/avatar-8.png" />
            <div>
          ...
          <Box
            sx={{
              backgroundImage: 'url(/static/assets/image-business-2.png)',
