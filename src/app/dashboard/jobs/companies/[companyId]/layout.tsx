...
const founders = [
  { id: 'USR-008', name: 'Jie Yan', avatar: '/static/assets/avatar-8.png', role: 'CEO & Co-founder' },
  { id: 'USR-005', name: 'Fran Perez', avatar: '/static/assets/avatar-5.png', role: 'CTO & Co-founder' },
  { id: 'USR-011', name: 'Omar Darboe', avatar: '/static/assets/avatar-11.png', role: 'CFO' },
] satisfies Founder[];
          ...
          <Grid lg={8} xs={12}>
            <Card>
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center', p: 3 }}>
                <Avatar src="/static/assets/company-avatar-1.png" variant="rounded" />
                <div>
