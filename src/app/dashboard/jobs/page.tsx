...
const companies = [
  {
    id: 'COM-004',
    name: 'Vercel',
    logo: '/static/assets/company-avatar-4.png',
  ...
  },
  {
    id: 'COM-003',
    name: 'Auth0',
    logo: '/static/assets/company-avatar-3.png',
  ...
  },
  {
    id: 'COM-002',
    name: 'Google Cloud',
    logo: '/static/assets/company-avatar-2.png',
  ...
  },
  {
    id: 'COM-001',
    name: 'Stripe',
    logo: '/static/assets/company-avatar-1.png',
          ...
          <Grid container sx={{ alignItems: 'center' }}>
            ...
            <Grid sm={5} sx={{ display: { xs: 'none', sm: 'flex' }, justifyContent: 'center' }}>
              <Box
                alt="Shield"
                component="img"
                src="/static/assets/iconly-glass-shield.svg"
