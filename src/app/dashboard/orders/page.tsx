...
const orders = [
  {
    id: 'ORD-005',
    customer: { name: 'Penjani Inyene', avatar: '/static/assets/avatar-4.png', email: 'penjani.inyene@domain.com' },
    lineItems: 1,
  ...
  {
    id: 'ORD-004',
    customer: { name: 'Jie Yan', avatar: '/static/assets/avatar-8.png', email: 'jie.yan@domain.com' },
    lineItems: 1,
  ...
  {
    id: 'ORD-003',
    customer: { name: 'Fran Perez', avatar: '/static/assets/avatar-5.png', email: 'fran.perez@domain.com' },
    lineItems: 2,
  ...
  {
    id: 'ORD-002',
    customer: { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png', email: 'carson.darrin@domain.com' },
    lineItems: 1,
  ...
  {
    id: 'ORD-001',
    customer: { name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png', email: 'miron.vitold@domain.com' },
    lineItems: 2,
