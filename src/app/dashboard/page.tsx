              ...
              subscriptions={[
                {
                  id: 'supabase',
                  title: 'Supabase',
                  icon: '/static/assets/company-avatar-5.png',
                  costs: '$599',
                  billingCycle: 'year',
                  status: 'paid',
                },
              ...
              messages={[
                {
                  ...
                  author: { name: 'Alcides Antonio', avatar: '/static/assets/avatar-10.png', status: 'online' },
                  createdAt: dayjs().subtract(2, 'minute').toDate(),
                },
                {
                  id: 'MSG-002',
                  content: 'Is the job still available?',
                  author: { name: 'Marcus Finn', avatar: '/static/assets/avatar-9.png', status: 'offline' },
                  createdAt: dayjs().subtract(56, 'minute').toDate(),
                },
                {
                  id: 'MSG-003',
                  content: "What is a screening task? I'd like to",
                  author: { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png', status: 'online' },
                  createdAt: dayjs().subtract(3, 'hour').subtract(23, 'minute').toDate(),
                },
                {
                  id: 'MSG-004',
                  content: 'Still waiting for feedback',
                  author: { name: 'Fran Perez', avatar: '/static/assets/avatar-5.png', status: 'online' },
                  createdAt: dayjs().subtract(8, 'hour').subtract(6, 'minute').toDate(),
                },
                {
                  id: 'MSG-005',
                  content: 'Need more information about campaigns',
                  author: { name: 'Jie Yan', avatar: '/static/assets/avatar-8.png', status: 'offline' },
