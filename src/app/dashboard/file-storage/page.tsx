...
const items = [
  {
    ...
    author: { name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
    isFavorite: true,
    isPublic: false,
    tags: ['Secrets', 'Important'],
    shared: [
      { name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png' },
      { name: 'Alcides Antonio', avatar: '/static/assets/avatar-10.png' },
      { name: 'Nasimiyu Danai', avatar: '/static/assets/avatar-7.png' },
    ],
    itemsCount: 3,
    size: '5 MB',
  ...
  },
  {
    ...
    tags: ['Work'],
    shared: [
      { name: 'Sofia Rivers', avatar: '/static/assets/avatar.png' },
      { name: 'Nasimiyu Danai', avatar: '/static/assets/avatar-7.png' },
    ],
    size: '1.2 MB',
  ...
  },
  {
    ...
    isPublic: false,
    tags: ['Personal'],
    shared: [{ name: 'Omar Darobe', avatar: '/static/assets/avatar-11.png' }],
    size: '16.7 MB',
  ...
  },
  {
    ...
    isPublic: false,
    tags: ['Security'],
    shared: [{ name: 'Siegbert Gottfried', avatar: '/static/assets/avatar-2.png' }],
    size: '13.37 KB',
