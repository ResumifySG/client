...
const invoices = [
  {
    id: 'INV-005',
    customer: { name: 'Jie Yan', avatar: '/static/assets/avatar-8.png' },
    currency: 'USD',
    totalAmount: 23.11,
    status: 'pending',
  ...
  {
    id: 'INV-004',
    customer: { name: 'Omar Darobe', avatar: '/static/assets/avatar-11.png' },
    currency: 'USD',
    totalAmount: 253.76,
    status: 'paid',
  ...
  {
    id: 'INV-003',
    customer: { name: 'Carson Darrin', avatar: '/static/assets/avatar-3.png' },
    currency: 'USD',
    totalAmount: 781.5,
    status: 'canceled',
  ...
  {
    id: 'INV-002',
    customer: { name: 'Fran Perez', avatar: '/static/assets/avatar-5.png' },
    currency: 'USD',
    totalAmount: 96.64,
    status: 'paid',
  ...
  {
    id: 'INV-001',
    customer: { name: 'Miron Vitold', avatar: '/static/assets/avatar-1.png' },
    currency: 'USD',
    totalAmount: 19.99,
    status: 'pending',
    issueDate: dayjs().subtract(2, 'hour').subtract(15, 'day').toDate(),
