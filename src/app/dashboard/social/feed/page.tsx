...
const posts = [
    ...
    comments: [
      {
        ...
        author: { name: 'Nasimiyu Danai', avatar: '/static/assets/avatar-7.png' },
  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        ...
        author: { name: 'Fran Perez', avatar: '/static/assets/avatar-5.png' },
  ...
  },
  {
    ...
    media: '/static/assets/image-business-2.png',
    comments: [
      {
        id: 'MSG-001',
      ...
      },
      {
        id: 'MSG-002',
        content: 'Absolutely!',
        author: { name: 'Penjani Inyene', avatar: '/static/assets/avatar-4.png' },
